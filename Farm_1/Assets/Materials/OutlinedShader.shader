...
Shader "Outlined/UltimateOutline"
{
	Properties
	{
		...
		_FirstOutlineColor("Outline color", Color) = (1,0,0,0)
		_FirstOutlineWidth("Outlines width", Range(0.0, 2.0)) = 0

		_SecondOutlineColor("Outline color", Color) = (1,0.996,0,0.4)
		_SecondOutlineWidth("Outlines width", Range(0.0, 2.0)) = 0.15
